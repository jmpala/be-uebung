...
<main>
    <div class="container-md">
        <div class="row vh-100 justify-content-center align-content-center">
            ...
            <form class="loginform__form py-3 px-1 p-md-3 rounded-3">
                <input type="text" id="email" class="loginform__username rounded-2 w-100" required>
                <label for="email" class="loginform__usernameLbl w-100">User Name</label>
                <input type="password" id="password" class="loginform__password rounded-2 w-100" required>
