...
<head>
    ...
    <script defer src="/dist/js/confirmUser.82d9792c2abac3d65828.js"></script></head>
</head>
...
<main>
    <div class="container">
        ...
        <form class="row justify-content-around" action="/admin/user/edit/process" method="POST">
